...
Mobile.tap(findTestObject('Object Repository/Update_delete/android.widget.RelativeLayout'), 0)

Mobile.clearText(findTestObject('Object Repository/Update_delete/android.widget.EditText - Task01'), 0)

Mobile.setText(findTestObject('Object Repository/Update_delete/android.widget.EditText - Task name (1)'), 'Taskupdate', 
    0)
